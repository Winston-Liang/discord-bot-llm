...
var BOT_TOKEN = process.env.DISCORD_LLAMA2_BOT_TOKEN;
var CLIENT_ID = process.env.DISCORD_LLAMA2_BOT_CLIENT_ID;
var deploy = function () { return __awaiter(void 0, void 0, void 0, function () {
    var commands, foldersPath, commandFolders, _i, commandFolders_1, folder, commandsPath, commandFiles, _a, commandFiles_1, file, filePath, command, rest;
    return __generator(this, function (_b) {
        commands = [];
        foldersPath = path_1.default.join(__dirname, '../commands');
        ...
        rest = new discord_js_1.REST().setToken(BOT_TOKEN !== null && BOT_TOKEN !== void 0 ? BOT_TOKEN : "");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, rest.put(discord_js_1.Routes.applicationCommands(CLIENT_ID !== null && CLIENT_ID !== void 0 ? CLIENT_ID : ""), { body: commands })];
                    case 1:
                        data = _a.sent();
